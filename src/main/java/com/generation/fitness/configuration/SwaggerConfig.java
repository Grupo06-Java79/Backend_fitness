	...
	OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto App Fitness").description("Projeto App Fitness - Generation Brasil")
						...
						.contact(new Contact().name("Grupo 06").url("https://github.com/Grupo06-Java79")
								.email("https://github.com/Grupo06-Java79")))
				.externalDocs(new ExternalDocumentation().description("Github")
						.url("https://github.com/Grupo06-Java79/Backend_fitness/"));
	}
